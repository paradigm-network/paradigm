...
import (
	...
	"github.com/paradigm-network/paradigm/crypto/keypair"
	"github.com/paradigm-network/paradigm/common"
	"github.com/paradigm-network/paradigm/common/log"
	"github.com/paradigm-network/paradigm/common/serialization"
	"github.com/paradigm-network/paradigm/core/signature"
...
var logger = log.GetLogger("message types")
...
func (this *ConsensusPayload) ToArray() []byte {
	...
	if err != nil {
		logger.Error().Msgf("consensus payload serialize error in ToArray(). payload:%v", this)
		return nil
	}
	return b.Bytes()
}
